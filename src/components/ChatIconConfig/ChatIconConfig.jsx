...
const ChatIconConfig = () => {
  ...
  return (
    <div className={styles.chatIconConfig}>
      ...
      <div className="form-group">
        <label htmlFor="distanceBottom">Distance from Bottom (in px)</label>
        <input
          type="text"
          id="distanceBottom"
          name="distanceBottom"
      ...
      <div className="form-group">
        <label htmlFor="horizontalDistance">Horizontal Distance (in px)</label>
        <input
          type="text"
        ...
        <div className={styles.uploadWrapper}>
          ...
          <div className={styles.uploadbtnWrapper}>
            <input
              ...
              style={{ display: "none" }}
            />
            <button className="btn btn-purple" onClick={handleUploadClick}>
              Upload Image <Upload />
            </button>
